...
exports.handleEvent = async function (o) {
    ...
    // console.log("Văn bản đầu vào:", text); // Đã tắt log spam
    ...
    // console.log("URL tìm thấy:", urls); // Đã tắt log spam
